...
def match_permutations_substrings(string, words):
    ...
    return {_ for _ in perms if _ in words}                                        # your solution
...
def uniq_srt(it):
    ...
    return sorted(list({_ for _ in it}))                                      # your solution
...
def uniq_orig_order(it):
    ...
    return [_ for _ in dict.fromkeys(it).keys()]                                     # your solution
